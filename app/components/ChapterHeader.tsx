    ...
    <>
      ...
      <div className="w-full flex items-center justify-between bg-[#a4150b] px-4 py-2">
        <div className="flex items-center">
          ...
          <span className="text-white text-lg font-medium font-serif">Tutor for Computer Networking: A Top-Down Approach</span>
        </div>
        <Link href="/" className="text-white text-xl font-medium focus:outline-none hover:bg-red-800 px-2 py-1 rounded font-sans" aria-label="Home">
          🏠
        </Link>
      </div>
      ...
      <div className="flex flex-col items-center mt-4 mb-2">
        ...
        <h2 className="text-xl md:text-2xl font-medium mb-1 text-center text-gray-900 font-serif">
          {isRAG ? `Custom RAG Tutor - Chapter ${chapterNumber}: ${chapterTitle}` : `Chapter ${chapterNumber}: ${chapterTitle}`}
        </h2>
        <p className="text-gray-700 text-center max-w-2xl text-sm font-medium leading-relaxed font-sans">
          {isRAG 
